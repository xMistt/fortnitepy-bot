...
> You can get an exchange code by clicking the link below, logging in and then copying the visible code. You can generate a new exchange code by refreshing the page if needed.
