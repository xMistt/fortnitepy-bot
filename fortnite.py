...
async def event_friend_message(message):
    ...
    if "!help" in args[0]:
        await message.reply('My commands are; !purpleskull, !checkeredrenegade, !variants, CID_, EID_, BID_, PICKAXE_ID_ !banner, !stop, !skin, !emote, !pickaxe, !searchpoint, !point, !ready, !unready & !help')
